...
public class AutoExtinguish extends Module {
    ...
    public AutoExtinguish() {
        super(Categories.Combat, "auto-extinguish", "Automatically extinguishes fire around you");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (waterBucket.get() && doesWaterBucketWork) {
            ...
            } else if (!mc.player.hasStatusEffect((RegistryEntry<StatusEffect>) FIRE_RESISTANCE) && mc.player.isOnFire()) {
                blockPos = mc.player.getBlockPos();
