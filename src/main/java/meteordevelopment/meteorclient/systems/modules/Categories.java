...
public class Categories {
    ...
    public static final Category Dupes = new Category("Dupes", Items.DIAMOND_BLOCK.getDefaultStack());
    public static final Category Griefs = new Category("Griefs", Items.TNT.getDefaultStack());
    ...
    public static void init() {
        ...
        Modules.registerCategory(Griefs);
