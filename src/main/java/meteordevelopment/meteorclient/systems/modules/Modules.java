...
import meteordevelopment.meteorclient.systems.modules.dupes.InvDupeModule;
import meteordevelopment.meteorclient.systems.modules.dupes.ItemFrame;
import meteordevelopment.meteorclient.systems.modules.dupes.ShulkerDupe;
...
public class Modules extends System<Modules> {
    ...
    private void initCombat() {
        add(new AimAssist());  // From Meteor Rejects
        add(new AutoExtinguish());  // From Meteor Rejects
        add(new AnchorAura());
        add(new AntiAnvil());
        add(new AntiBed());
        add(new ArrowDodge());
    ...
    private void initPlayer() {
        add(new AutoCraft()); // From Meteor Rejects
        add(new AutoEnchant()); // From Meteor Rejects
        add(new AutoDisenchant()); // From Meteor Rejects
        add(new AutoFarm()); // From Meteor Rejects
        add(new AntiHunger());
        add(new AutoEat());
        add(new AutoFish());
        add(new AutoGap());
    ...
    private void initMovement() {
        ...
        add(new BoatFly());
        add(new ClickTP());
        add(new AutoElytraReplace()); // By NinjaSiren
        add(new ElytraBoost());
        add(new ElytraFly());
    ...
    private void initRender() {
        add(new NewChunks());  // From Meteor Rejects
    ...
    private void initMisc() {
        add(new MiddleClickFriend()); // By NinjaSiren
        add(new PlayerOnline()); // By NinjaSiren
        add(new DetectVanish()); // From Meteor Rejects
        add(new Swarm());
    ...
    private void initDupes() {
        add(new ItemFrame()); // From Colonizadores & Carlox (6b6t)
        add(new ShulkerDupe()); // From Trouser Streak
        add(new InvDupeModule()); // From Trouser Streak
    }

    private void initGriefs() {
        add(new AutoIgniteTNT());
        add(new AutoLavacast());
        add(new AutoWither()); // From Meteor Rejects
    }
