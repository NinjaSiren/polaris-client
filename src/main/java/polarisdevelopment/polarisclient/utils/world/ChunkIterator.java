...
import polarisdevelopment.polarisclient.mixin.ClientChunkManagerAccessor;
import polarisdevelopment.polarisclient.mixin.ClientChunkMapAccessor;
...
public class ChunkIterator implements Iterator<Chunk> {
    private final ClientChunkMapAccessor map = (ClientChunkMapAccessor) (Object) ((ClientChunkManagerAccessor) MeteorClient.mc.world.getChunkManager()).getChunks();
